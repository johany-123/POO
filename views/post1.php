...
<body>
    ...
    <div class="container">
        <article class="post">
            <h1 class="post-title">Infografia</h1>
            <p class="post-meta">Publicado el <span>16/2/2025</span> por <span>Autor desconocido</span></p>
            <img src="https://via.placeholder.com/800x400" alt="Imagen del post" class="post-image">
            <p class="post-content">
            Jonathan est optimus magister qui docere POO 
            </p>
            <p class="post-content">
               lo que cuenta la publicacion
            </p>
        </article>
    </div>
